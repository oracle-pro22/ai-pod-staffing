...
""" + run("LOCK TABLE AIPS_MIG_BACKUP IN EXCLUSIVE MODE NOWAIT")
    ...
    policies = {
        "POD_CAPTAIN": {"DASHBOARD":("FULL","YNNNNN"),"REQUESTS":("FULL","YYYNNN"),"AI_FITMENT":("FULL","YYYYNN"),"ALLOCATION_CALENDAR":("FULL","YNNNNN"),"TEAM_SKILLS":("FULL","YNNNNN"),"MY_AVAILABILITY":("OWN","YNNNNN"),"AGENT_EXECUTION":("FULL","YYNNNN"),"REPORTS":("FULL","YNNNYN")},
        "POD_LEAD": {"DASHBOARD":("SCOPED","YNNNNN"),"REQUESTS":("SCOPED","YNYNNN"),"AI_FITMENT":("SCOPED","YNNNNN"),"ALLOCATION_CALENDAR":("SCOPED","YNNNNN"),"TEAM_SKILLS":("SCOPED","YNNNNN"),"MY_AVAILABILITY":("OWN","YNNNNN"),"REPORTS":("SCOPED","YNNNNN"),"PROJECT_CLOSURE":("SCOPED","YNYNNN")},
        "POD_MEMBER": {"DASHBOARD":("SCOPED","YNNNNN"),"REQUESTS":("SCOPED","YNNNNN"),"TEAM_SKILLS":("OWN","YNNNNN"),"MY_AVAILABILITY":("OWN","YNNNNN"),"REPORTS":("OWN","YNNNNN")},
        "SYSTEM_ADMINISTRATOR": {"REPORTS":("FULL","YNNNYN"),"ADMINISTRATION":("FULL","YYYNNY"),"ACCESS_MANAGEMENT":("FULL","YYYNNY"),"BACKEND_CONFIGURATION":("FULL","YYYNNY")},
    }
